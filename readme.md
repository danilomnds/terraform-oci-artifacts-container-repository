...
|----------------|-------------------|----------------------|
| v1.0.0         | v1.14.8           | 8.8.0                |
| v1.1.0         | v1.14.8           | 8.9.0                |
...
module "artifacts_container_repository" {    
  source = "git::https://timbrasil@dev.azure.com/timbrasil/Projeto_IaC/_git/oci-module-artifacts-container-repository?ref=v1.1.0"
  compartment_id = "<compartment_ocid>"
  tenancy_ocid   = var.tenancy_ocid
  # Only on the first repository it should be true!!!
  policies     = true
  defined_tags = {
    "IT.area" : ""
    "IT.environment" : ""
...
| readme | Container repository readme | `object({})` | `null` | No |
...
| tenancy_ocid | Tenancy OCID where the container repository will be created | `string` | n/a | `Yes` |
| policies | Should access policies be created? If you have more than one repository, specify it only once | `bool` | `false` | No |
